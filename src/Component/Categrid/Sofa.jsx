...
const ProductSection = () => {
    ...
    const handleAddItem = () => {
        addToCart(); // Pass the item details to addToCart
        ...
        const categories = [
            ...
            { id: 'sofa', name: 'Sofa Beds' },
            { id: 'Sleeper', name: 'Sleeper sofas' },
            { id: 'Camelback', name: 'Camelback Sofa' },
            { id: 'Leather', name: 'Leather sofas' }
        ];
        ...
        return (
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
                ...
                <div className="flex justify-between items-center mb-6">
                    <h1 className='text-4xl font-serif font-bold'>Sofa&lsquo;s</h1>
                            ...
                            >
                                <div className="relative bg-white rounded-lg shadow-md overflow-hidden">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <button onClick={handleAddItem} className="w-full bg-black hover:bg-gray-800 text-white py-2 rounded-md flex items-center justify-center space-x-2 transition-colors">
